    ...
    return (
      <div className='flex flex-grow justify-between p-2 border header-bar'>
        ...
        <div className='flex items-center'>
          <img className='mr-3' alt='logo' src={question} width='18' height='18'/>
          
          <div className='bg-purple-500 flex items-center rounded-full text-white text-center text-sm p-2 w-8 h-8' src={question}>
            {this.props.name}
          </div>
